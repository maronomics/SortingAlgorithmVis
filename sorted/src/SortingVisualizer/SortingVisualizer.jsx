...
export default class SortingVisualizer extends React.Component {
  ...
  resetArray() {
    const array = [];
    for (let i = 0; i < 310; i++) {
      array.push(randomIntFromInterval(5, 565));
    }
    console.log(array);
    this.setState({ array });
    ...
    return (
      <div className="mainBody">
        ...
        <div className="button-container">
          <button class="buttons" onClick={() => this.resetArray()}>
            Generate New Array
          </button>
          <button class="buttons" onClick={() => this.mergeSort()}>
            Merge Sort
          </button>
          <button class="buttons" onClick={() => this.quickSort()}>
            Quick Sort
          </button>
          <button class="buttons" onClick={() => this.heapSort()}>
            Heap Sort
          </button>
          <button class="buttons" onClick={() => this.bubbleSort()}>
            BubbleSort
          </button>
        </div>
      </div>
